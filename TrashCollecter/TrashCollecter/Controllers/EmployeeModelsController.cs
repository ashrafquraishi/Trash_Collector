...
namespace TrashCollecter.Controllers
{
    public class EmployeeModelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,DateOfBirth,PickUps")] EmployeeModel employeeModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName,DateOfBirth,PickUps")] EmployeeModel employeeModel)
        {
            if (ModelState.IsValid)
            {
